 ...
 * @see <a href="https://mariadb.com/kb/en/library/resultset/#column-definition-packet">Column definition
 * packet</a>
 */
public final class MySQLColumnDefinition41Packet implements MySQLPacket {
    ...
    public MySQLColumnDefinition41Packet(final int sequenceId, final int flags, final String schema,
        final String table, final String orgTable,
        final String name, final String orgName, final int columnLength, final MySQLColumnType columnType,
        final int decimals) {
